...
18、若仅实现科学上网且不需要 NaiveProxy 支持 HTTP/3 代理应用，推荐采用 [V2Ray(E+B+D+G+A)+Trojan+Caddy(N)](https://github.com/lxhao61/integrated-examples/tree/main/V2Ray(E%2BB%2BD%2BG%2BA)%2BTrojan%2BCaddy(N)) 示例。
