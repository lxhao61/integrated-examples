...
Hysteria 是一个强大、快速、抗审查的代理工具。基于魔改的 QUIC 协议，Hysteria 即使在最不稳定和容易丢包的网络环境中也能提供无与伦比的性能。
...
2、1_hysteria.yaml 表示使用内置 ACME 客户端自动申请与更新 TLS 证书，2_hysteria.yaml 表示使用外部 TLS 证书。
