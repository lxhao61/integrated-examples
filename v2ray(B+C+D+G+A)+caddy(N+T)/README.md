...
利用 caddy 支持 WebSocket（WS）、H2C、gRPC 反向代理及 naiveproxy 与 trojan-go 正向代理，实现除 Xray 或 v2ray 的 KCP 应用外，WebSocket（WS）、H2C、gRPC 类应用及 naiveproxy 与 trojan-go 应用共用443端口。包括应用如下：
