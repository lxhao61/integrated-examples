...
3、VLESS+XHTTP+REALITY（套娃配置，REALITY 由 VLESS+Vision+REALITY 启用及处理。）
...
7、使用本人 Releases 中编译好的 Caddy 文件，可同时支持定向转发 UDP、NaiveProxy、Trojan-Go 及 PROXY protocol 接收等应用。
