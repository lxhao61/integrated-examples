...
本配置是 trojan 或 trojan-go 应用，trojan\trojan-go 以 h2 或 http/1.1 自适应协商连接，非 trojan\trojan-go 的 https 连接回落给 caddy（即解除 tls 后的 web 连接转给 caddy 处理），tls 由 trojan\trojan-go 提供及处理。
