...
2. [v2ray(E+B+F+C+D+G+A)+naiveproxy](https://github.com/lxhao61/integrated-examples/tree/main/v2ray(E%2BB%2BF%2BC%2BD%2BG%2BA)%2Bnaiveproxy) （兼顾vless\trojan+tcp+tls及naiveproxy的综合应用，caddy SNI共用端口。）
#### &emsp;兼顾各自优势的综合应用。
