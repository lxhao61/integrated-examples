...
3、若本示例目标网站使用自己的，其配置可参考 [Xray(M+H+K+A)+Nginx](https://github.com/lxhao61/integrated-examples/tree/new/Xray(M%2BH%2BK%2BA)%2BNginx) 或 [Xray(M+H+K+A)+Caddy(N+T)](https://github.com/lxhao61/integrated-examples/tree/new/Xray(M%2BH%2BK%2BA)%2BCaddy(N%2BT)) 示例中 VLESS+Vision+REALITY 应用。
